                ...
                <div>
                  <List bulleted>
                    <List.Item>
                      ...
                      Managed server-side data (REST API) and communications
                      between front-end and back-end using GitHub as Version
                      Control.
                    </List.Item>
                    <List.Item>
                      <span style={{ fontWeight: "bold" }}>
                      ...
                      Developed, managed and directed the front-end development
                      of an Android application in a team of 4 people. Great use
                      and deepening of Android Studio (Java), GitHub (Pull
                      Requests, Issues, Merge conflicts).
                    </List.Item>
                  </List>
                </div>
              }
