  ...
  return (
    <div className="work-experience-item">
      ...
      <div className="work-experience-item-company">
        {<a href={props.link} target="_blank" rel="noreferrer">{props.company}</a>}
      </div>
      <div className="row">
        ...
        <div className="work-experience-item-location df">
          ...
          <a className="link-location date">
            {<a href={props.locationlink} target="_blank" rel="noreferrer">{props.location}</a>}
          </a>
        </div>
      </div>
  ...
  return (
    <div className="education-item">
      ...
      <div className="education-item-school">
        {<a href={props.link} target="_blank" rel="noreferrer">{props.school}</a>}
      </div>
            ...
            <div className="links-container">
              <div className="column1">
                <div className="github df">
                  ...
                  <a href={github_url} target="_blank" rel="noreferrer" className="link-github link">
                    github.com/yangxdev
                  </a>
                </div>
                <div className="linkedin df">
                  ...
                  <a href={linkedin_url} target="_blank" rel="noreferrer" className="link-linkedin link">
                ...
                <div className="instagram df">
                  ...
                  <a href={instagram_url} target="_blank" rel="noreferrer" className="link-instagram link">
              ...
              <div className="column2">
                <div className="email df">
                  ...
                  <a href={"mailto:" + email} target="_blank" rel="noreferrer" className="link-email link">
                ...
                <div className="number df">
                  ...
                  <a href={"tel:" + phone} target="_blank" rel="noreferrer" className="link-phone link">
                    +39 334 222 9699
                  </a>
                </div>
            ...
            <div className="demositeqr">
              ...
              <div className="demositeqr-title">
                <div className="demositeqr-txt">
                  <a href="https://yangxdev.github.io/fe8-room-homepage/" target="_blank" rel="noreferrer">
                    Demo Site
                  </a>
                </div>
              </div>
            ...
            <div className="linktreeqr">
              ...
              <div className="linktreeqr-title">
                <div className="linktreeqr-txt">
                  <a href="https://linktr.ee/yang.xng" target="_blank" rel="noreferrer">My Links</a>
                </div>
              </div>
            </div>
          </div>
